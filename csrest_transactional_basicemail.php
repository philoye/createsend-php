...
class CS_REST_Transactional_BasicEmail extends CS_REST_Wrapper_Base {
     ...
     * @access public
     */
    function CS_REST_Transactional_BasicEmail (
    $auth_details,
    $client_id = NULL,
    $protocol = 'https',
    ...
    /**
     * Sends a new basic transactional email
     ...
     *             ) optional
     *         )
     * @param string $basic_group Optional. Name to group emails by for reporting
     ...
     *      )
     */
    function send($message, $basic_group = NULL, $add_to_list_ID = NULL, $options = array()) {
        $basic_group_param = array( "BasicGroup" => $basic_group);
        $add_to_list_param = array( "AddRecipientsToListID" => $add_to_list_ID);
        $data = array_merge($this->_client_id_param, $message, $basic_group_param, $add_to_list_param, $options);
        return $this->post_request($this->_base_route.'transactional/basicemail/send', $data);
    }

    /**
     * Gets the list of Basic Groups
     * @access public
    ...
    function groups() {
        ...
        return $this->get_request($this->_base_route . 'transactional/basicemail/groups', $data);
    }
